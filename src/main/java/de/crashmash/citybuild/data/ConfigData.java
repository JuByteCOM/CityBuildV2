...
public class ConfigData {
    ...
    public static boolean CONFIG_COMMAND_CHATCLEAR = CityBuildV2.getPlugin().getConfig().getBoolean("Settings.Commands.ClearChat");
    ...
    public static boolean CONFIG_COMMAND_UNSTARTKICK = CityBuildV2.getPlugin().getConfig().getBoolean("Settings.Commands.Unstartkick");
    ...
    public static boolean CONFIG_COMMAND_SLOWCHAT = CityBuildV2.getPlugin().getConfig().getBoolean("Settings.Commands.SlowChat");
