...
public class HealCommand extends AbstractCommand {
    ...
    public HealCommand() {
        super(ConfigData.CONFIG_COMMAND_HEAL_NAME, null, "Healed an other player", ConfigData.CONFIG_COMMAND_HEAL_ALIASES);
    }
                ...
                if (strings.length == 0){
                    ...
                    if (player.hasPermission(MessagesData.HEAL_COMMAND_PERMISSION_OTHER)){
                        ...
                        if (target != null){
                            ...
                            player.sendMessage(MessagesData.HEAL_COMMAND_MESSAGE_OTHER.replace("[targetPlayer]", strings[0]));
