...
public class HtmlUtils {
  ...
  public static HtmlResponse sendGetRequest(String url, String[] inputcookies, int timeout)
      throws Exception {
    URL obj = new URL(url);
   ...
   * @throws Exception Exception
   */
  public static HtmlResponse sendPostRequest(
      String url, Map<String, String> params, String[] inputcookies) throws Exception {
