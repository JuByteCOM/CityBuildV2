...
public class InvseeCommand extends AbstractCommand {
  ...
  public InvseeCommand() {
    super(
        ConfigData.CONFIG_COMMAND_INVSEE_NAME,
        null,
        "See inventories off other players.",
        ConfigData.CONFIG_COMMAND_INVSEE_ALIASES);
  }
  ...
  public List<String> onTabComplete(
    ...
    if (strings.length == 1
        && commandSender.hasPermission(MessagesData.INVSEE_COMMAND_PERMISSION_USE)) {
