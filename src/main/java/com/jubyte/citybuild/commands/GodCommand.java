...
public class GodCommand extends AbstractCommand {
  ...
  public GodCommand() {
    super(
        ConfigData.CONFIG_COMMAND_GOD_NAME,
        null,
        "Make yourself and other players invincible.",
        ConfigData.CONFIG_COMMAND_GOD_ALIASES);
  }
  ...
  public List<String> onTabComplete(
    ...
    if (strings.length == 1
        && commandSender.hasPermission(MessagesData.FARMWORLD_COMMAND_PERMISSION_ADMIN)) {
