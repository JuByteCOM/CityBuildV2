...
public class StartKickCache {
  ...
  public StartKickCache() {
    startKickPlayerCache =
        new ArrayCache<StartKickPlayer>()
            .setExpireAfterAccess(
                (MessagesData.STARTKICK_COMMAND_SETTING_DURATION + (60 * 5)), TimeUnit.SECONDS)
            .setMaxSize(500)
            .registerQuery(
                "byUUID",
                new CacheQuery<StartKickPlayer>() {
                  @Override
